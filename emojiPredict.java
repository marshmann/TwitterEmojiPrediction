...
public class emojiPredict{
    ...
    private static String temp[] =
        {"the","be","to","of","and","a","an","in","that","has","have","i","it","for",
        "not","on","with","as","you","at","this","because","we","them","","do","can"};
    ...
    public static void main(String args[]) throws IOException {
        ...
        String trialPath = sc.nextLine();
        String labelPath = sc.nextLine();

        BufferedReader text = new BufferedReader(new FileReader(trialPath)); 
        BufferedReader label = new BufferedReader(new FileReader(labelPath)); 
        
        getData(text,label); text.close(); label.close(); sc.close();
        ...
        System.out.println("If you just guessed the most common emoji, you would be correct " 
            + baseline + "% of the time.");
        System.out.printf("This method is correct %2.3f%% of the time.\n",(testCorrect));
        System.out.printf("The overall percent improvement is %2.3f%%.", 
            (testCorrect-baseline));    
    }
}
